...
class EcoSystem:
    def __init__(self, n_firms=5, rho=0.9, alpha=0.5, price=15.0): #tout à ajuster 
        ...
        self.pollution_threshold = 400 #à ajuster 
        self.death_penalty = -1000 #à ajuster 
        self.reset()
    ...
    def step_multi_firms(self, action_type, action_value, q_list):
        ...
        #ajout d'un seuil mortel 
        done = False

        if self.pollution >= self.pollution_threshold:
            done = True
    
            # catastrophe : tout le monde prend cher
        ...
        #return self._get_state(), social_welfare, individual_profits #version de base 
        return self._get_state(), social_welfare, individual_profits, done #ajout seuil mortel 
