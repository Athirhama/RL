...
class EcoSystem:
    def __init__(self, n_firms=5, rho=0.9, alpha=0.5, price=15.0): # Prix augmenté à 15
    ...
    def step_multi_firms(self, action_type, action_value, q_list):
        ...
        self.pollution = self.rho * self.pollution + current_q_total
        self.total_q = current_q_total
        
        # Calcul du Bien-être Social (Social Welfare)
        # SW = Somme des profits - Dégât environnemental (pollution^2)
        env_damage = self.pollution
